...
void AFGCharacterPlayer::OnUseStop_Implementation(class AFGCharacterPlayer* byCharacter, const FUseState& state) { }
...
void AFGCharacterPlayer::OnUse_Implementation( class AFGCharacterPlayer* byCharacter, const FUseState& state ){ }
