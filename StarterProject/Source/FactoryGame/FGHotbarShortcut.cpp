...
//bool UFGHotbarShortcut::IsValidShortcut(  AFGPlayerController* owner ) const{ return bool(); }
UTexture2D* UFGHotbarShortcut::GetDisplayImage_Implementation() const{ return nullptr; }
//UTexture2D* UFGHotbarShortcut::GetDisplayImage() const{ return nullptr; }
bool UFGHotbarShortcut::IsActive_Implementation(  AFGPlayerController* owner ) const{ return bool(); }
//bool UFGHotbarShortcut::IsActive(  AFGPlayerController* owner ) const{ return bool(); }
